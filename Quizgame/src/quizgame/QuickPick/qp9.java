 ...
 * @author admin
 */
public class qp9 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(qp9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
